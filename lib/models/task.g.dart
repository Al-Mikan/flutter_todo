...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> starEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'star',
        value: value,
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> sortByStar() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'star', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByStarDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> thenByStar() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'star', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByStarDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'star', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  ...
  QueryBuilder<Task, Task, QDistinct> distinctByStar() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, bool, QQueryOperations> starProperty() {
    return QueryBuilder.apply(this, (query) {
